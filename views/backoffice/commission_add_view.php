      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ajout d'une commission</h6>
          </div>
          <div class="card-body">
            <form action="commission_add_script.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <input type="number" class="form-control mt-2 mb-2" name="avancement" id="avancement" placeholder="état d'avancement" step="10" min="0" max="100">
                  </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mt-2 mb-2">
                        <input type="number" class="form-control mt-2 mb-2" name="prix" id="prix" placeholder="Prix" min="0" max="1000">
                    </div>
                    <div class="form-group col-md-6 mt-2 mb-2">
                        <input type="date" class="form-control mt-2 mb-2" name="deadline" id="deadline" placeholder="Le deadline">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12 mt-2 mb-2">
                        <textarea class="form-control mt-2 mb-2" name="description" id="description" rows="3" placeholder="Description"></textarea>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary mt-2">Ajouter dans la base de données</button>
            </form>
