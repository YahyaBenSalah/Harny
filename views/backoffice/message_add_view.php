      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ajout d'un message</h6>
          </div>
          <div class="card-body">
            <form action="message_add_script.php" method="POST" enctype="multipart/form-data">
                <div class="form-row">
                ...
                <div class="input-group mt-2 mb-2">
                  ...
                  <div class="form-group col-md-6 mt-2 mb-2">
                        <input type="date" class="form-control mt-2 mb-2" name="date_envoie" id="date_envoie" placeholder="La date d'envoie">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12 mt-2 mb-2">
                        <textarea class="form-control mt-2 mb-2" name="contenu" id="contenu" rows="3" placeholder="Message"></textarea>
                    </div>
                </div>
