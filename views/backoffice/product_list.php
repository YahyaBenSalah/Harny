<?php
  include_once "../../core/Crud_Produit.php";
...
<head>
  ...
  <script src="js/delconfirmation/delconfirmP.js"></script>
</head>
                    ...
                    <?php
                      foreach($list as $row){?>
                        <tr>
                          ...
                          <td>
                            <a href="product_update_view.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-icon-split">
